...
<div class="star-rating" title="' . sprintf(esc_html__("Rated %d out of 5", 'yith-woocommerce-advanced-reviews'), $rating) . '">
<span style="width:' . (($rating / 5) * 100) . '%"><strong>' . $rating . '</strong>' . esc_html__("out of 5", 'yith-woocommerce-advanced-reviews') . ' </span>
</div>
</div>';
                    }
