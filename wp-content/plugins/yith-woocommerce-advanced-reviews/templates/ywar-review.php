	...
	<div id="comment-<?php echo $review->ID; ?>" class="comment_container">
		...
		<div class="comment-text">
			...
			<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) : ?>
				...
				<div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf( esc_html__( 'Rated %d out of 5', 'yith-woocommerce-advanced-reviews' ), $rating ) ?>">
